      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 text-nowrap mt-5">
            <h1>Editer ou supprimer un article "Bars et restaurants"</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/dashboard">Accueil</a></li>
              <li class="breadcrumb-item active">Editer ou supprimer un article "Bars et restaurants"</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tous les articles "Bars et restaurants"</h3>
                ...
                <table class="table table-hover text-nowrap">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center pr-3">Type de restaurant</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                          <td class="align-middle text-center px-5">
                            <form action="/restaurants/{{ $restaurant->slug }}" method="POST" class="inline-block">
                              @csrf 
                              @method('delete')
                              <a href="/restaurants/{{ $restaurant->slug }}/edit" class="btn btn-info mr-3" role="button" data-bs-toggle="button">Editer</a>
