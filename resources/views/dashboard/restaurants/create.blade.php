    ...
    <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="/restaurants/create" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Créer un article</p>
                  </a>
                </li>
          ...
          <div class="row">
            <div class="col">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Créer un article "Bars et restaurants"</li>
              </ol>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <h1 class="mb-2">Créer un article "Bars et restaurants"</h1>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <form id="nouveauRest" method="POST" action="/restaurants" enctype="multipart/form-data">@csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label for="nameRest">Nom du restaurant</label>
                      <input name="nameRest" type="text" class="form-control" id="nameRest" placeholder="Nom du restaurant"
                        required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="cuisineLocale" value="Cuisine locale">
                          <label for="cuisineLocale" class="custom-control-label">Cuisine locale</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="indien" value="Indien">
                          <label for="indien" class="custom-control-label">Indien</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="japonais" value="Japonais">
                          <label for="japonais" class="custom-control-label">Japonais</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="chinois" value="Chinois">
                          <label for="chinois" class="custom-control-label">Chinois</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="thai" value="Thaï">
                          <label for="thai" class="custom-control-label">Thaï</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="italien" value="Italien">
                          <label for="italien" class="custom-control-label">Italien</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="libanais" value="Libanais">
                          <label for="libanais" class="custom-control-label">Libanais</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="francais" value="Français">
                          <label for="francais" class="custom-control-label">Français</label>
                        </div>
                        <br>
                        <br>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="africain" value="Africain">
                          <label for="africain" class="custom-control-label">Africain</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="asiatique" value="Asiatique">
                          <label for="asiatique" class="custom-control-label">Asiatique</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="europen" value="Européen">
                          <label for="europen" class="custom-control-label">Européen</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline mr-3">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="ameriqueNord" value="Américain du Nord">
                          <label for="ameriqueNord" class="custom-control-label">Américain du Nord</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="ameriqueSud" value="Américain du Sud">
                          <label for="ameriqueSud" class="custom-control-label">Américain du Sud</label>
                        </div>
                        <div class="custom-control custom-checkbox d-inline">
                          <input name="typeRest[]" class="custom-control-input" type="checkbox" id="autre" value="Autre">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="horairesRest" class="form-control" id="horairesRest" placeholder="Heures d'ouverture"
                        rows="3" required></textarea>
                    </div>
                    <div class="form-group">
                      <label for="prixRest">Prix</label>
                      <textarea name="prixRest" class="form-control" id="prixRest" placeholder="Prix"
                        rows="3" required></textarea>
                    </div>
                    <div class="form-group">
                      <label for="siteInternet">Site internet</label>
                      <input name="siteInternet" type="text" class="form-control" id="siteInternet"
                        placeholder="Site internet du restaurant">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="textRest" class="form-control" id="textRest" placeholder="Texte"
                        rows="8"></textarea>
                    </div>
                    <div>
