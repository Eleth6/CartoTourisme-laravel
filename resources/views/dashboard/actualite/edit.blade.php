          ...
          <div class="row">
            <div class="col">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Editer un article "Actualité et événements"</li>
              </ol>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <h1 class="mb-2 mt-3">Editer un article "Actualité et événements"</h1>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      </section>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <form id="nouvelArticle" method="POST" action="/actualite/{{ $post->slug }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                  <div class="card-body">
                    <div class="form-group mt-2">
                      <label for="titleArticle">Titre de l'article</label>
                      <input name="titleArticle" type="text" class="form-control" id="titleArticle" value="{{ $post->titleArticle }}"
                        required>
                    </div>
                    <div class="form-group mt-4">
                      <label for="dateArticle">Date de publication ou de l'événement</label>
                      <input name="dateArticle" type="date" class="form-control" id="dateArticle" value="{{ $post->dateArticle }}" required>
                    </div>
                    <div class="form-group mt-4">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          ...
                          <label class="custom-file-label" for="imageArticle">{{ $post->imageArticle }}</label>
                        </div>
                    ...
                    <div class="form-group mt-4">
                      ...
                      <textarea name="summaryArticle" class="form-control" id="summaryArticle" maxlength="220"
                        onkeyup="countChar(this)" rows="2">{{ $post->summaryArticle }}</textarea>
                      <div class="text-right" id="charNum"></div>
                    </div>
                    <div class="form-group mt-4">
                      <label for="textArticle">Texte</label>
                      <textarea name="textArticle" class="form-control" id="textArticle" rows="8">
                        {{ $post->textArticle }}
                      </textarea>
                    </div>
                    <div>
